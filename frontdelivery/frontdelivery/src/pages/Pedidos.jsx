...
function Pedidos() {
  ...
  const mudarStatus = (id, novoStatus) => {
    axios.put(`http://localhost:5001/pedido/${id}/status`, { status: novoStatus })
        .then(() => {
            carregarDados() // Atualiza a lista para mudar a cor e o botão
        })
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10">
        <h1 className="text-4xl font-black text-center mb-12 text-white drop-shadow-md">🛵 Gerenciar Pedidos</h1>
        ...
        <div className="max-w-6xl mx-auto">
            <h2 className="text-2xl font-black mb-6 text-white drop-shadow-md">Pedidos em Andamento</h2>
            
            {pedidosRealizados.length === 0 ? (
                <div className="text-center py-16 bg-white/10 rounded-xl backdrop-blur-sm shadow-lg">
                    <p className="text-xl text-white font-semibold">Nenhum pedido realizado ainda</p>
                </div>
            ) : (
                            ...
                            <div className="flex-1">
                                <div className="flex justify-between items-start">
                                    <div>
                                        ...
                                        <p className="text-sm text-purple-600 font-semibold mt-1">🍽️ {pedido.nome_restaurante}</p>
                                    </div>
                                ...
                                <div className="mt-4 bg-purple-50 p-3 rounded-lg border border-purple-100">
                                    ...
                                    <p className="text-gray-600 text-sm mt-1">
                                        {pedido.itens_lista ? pedido.itens_lista : "Carregando itens..."}
                                    </p>
                                </div>
                            </div>
